 ...
 */
public final class DefaultXmlReader_Android_Replace extends XmlReader {
    ...
    public static XmlReader fromStream(InputStream xml) throws XMLStreamException {
        Objects.requireNonNull(xml, "'xml' cannot be null.");
        return new DefaultXmlReader_Android_Replace(XML_INPUT_FACTORY.createXMLStreamReader(xml));
    }
    ...
    private DefaultXmlReader_Android_Replace(XMLStreamReader reader) {
        this.reader = reader;
