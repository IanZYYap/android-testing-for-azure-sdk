 ...
 */
public final class DefaultXmlWriter_Android_Replace extends XmlWriter {
    ...
    public static XmlWriter toStream(OutputStream xml) throws XMLStreamException {
        ...
        return new DefaultXmlWriter_Android_Replace(XML_OUTPUT_FACTORY.createXMLStreamWriter(
    ...
    public static XmlWriter toWriter(Writer xml) throws XMLStreamException {
        Objects.requireNonNull(xml, "'xml' cannot be null.");
        return new DefaultXmlWriter_Android_Replace(XML_OUTPUT_FACTORY.createXMLStreamWriter(xml));
    }

    private DefaultXmlWriter_Android_Replace(XMLStreamWriter writer) {
        this.writer = writer;
    }
