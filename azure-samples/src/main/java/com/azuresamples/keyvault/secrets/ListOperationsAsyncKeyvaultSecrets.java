...
package com.azuresamples.keyvault.secrets;
 ...
 */
public class ListOperationsAsyncKeyvaultSecrets {
    /**
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // You need to check if any of the secrets are sharing same values. Let's list the secrets and print their
        // values. List operations don't return the secrets with value information. So, for each returned secret we
        // call getSecret() to get the secret with its value information.
